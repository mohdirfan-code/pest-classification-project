import torch, timm, io, os, sqlite3, re
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        print(f"❌ ERROR: Could not configure Gemini API. Error: {e}")
            ...
            try:
                ...
                if header == "CHEMICAL SOLUTIONS":
                    ...
                    for line in lines:
                        ...
                        if len(parts) == 2:
                            pesticide, notes = parts[0].strip(), parts[1].strip()
                        else:
                            pesticide, notes = cleaned, "Consult packaging for detailed information."
